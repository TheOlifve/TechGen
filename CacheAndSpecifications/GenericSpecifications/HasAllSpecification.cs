...
public class HasAllSpecification<TEntity, TItem>: ISpecification<TEntity>
{
    readonly Func<TEntity, IEnumerable<TItem>> _getter;
    readonly ISpecification<TItem> _specification;

    public HasAllSpecification(Func<TEntity, IEnumerable<TItem>> getter, ISpecification<TItem> specification)
    {
